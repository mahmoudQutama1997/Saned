...
urlpatterns = [
    ...
    path('donor/confirm_payment/<int:campaign_id>/',views.confirm_payment,name='confirm_payment'),
    path('donor/payment_success/<int:campaign_id>/',views.payment_success,name='payment_success'),
